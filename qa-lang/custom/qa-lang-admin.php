...
*/
	...
	return array(
		...
		'approve_user_popup' => 'Approve ideator',
		'approve_users_title' => 'Approve ideators',
		...
		'block_user_popup' => 'Block ideator',
		...
		'categories_not_shown' => 'Some ideas have categories which will not be displayed.',
		...
		'category_no_sub_error' => '^q idea/s in this category have no sub-category - ^1set sub-category^2',
		'category_no_sub_to' => 'Move ideas in ^ with no sub-category to:',
		'category_no_subs' => 'None',
		'category_none_error' => '^q idea/s currently have no category - ^1set category^2',
		'category_none_to' => 'Move ideas with no category to:',
		...
		'delete_category_reassign' => 'Delete this category and reassign its ideas to:',
		...
		'delete_hidden_note' => ' - all hidden ideas, feedback and comments without dependents',
		...
		'from_users' => 'From ideators:',
		'general_title' => 'General',
		'hidden_answers_deleted' => 'Deleted ^1 of ^2 hidden feedback without dependents...',
		'hidden_comments_deleted' => 'Deleted ^1 of ^2 hidden comments...',
		'hidden_questions_deleted' => 'Deleted ^1 of ^2 hidden ideas without dependents...',
		'hidden_title' => 'Hidden',
		'hotness_factors' => 'Relative importance for idea hotness:',
		...
		'mailing_explanation' => 'Ideators will be able to unsubscribe on their account page.',
		'mailing_progress' => 'Mailing completed for ^1 of ^2 ideators...',
		...
		'no_image_gd' => 'The installed version of PHP was compiled without GD image support, so ideators cannot upload their avatars directly.',
		'no_link' => 'No link',
		...
		'no_unapproved_found' => 'No ideators waiting for approval',
		...
		'per_user_hour' => 'per ideator/hour',
		...
		'profile_fields' => 'Extra fields on ideator pages or registration form:',
		...
		'question_lists' => 'Idea lists',
		'question_pages' => 'Idea pages',
		...
		'recalc_categories_recounting' => 'Recounting ideas for ^1 of ^2 categories...',
		'recalc_categories_updated' => 'Recalculated for ^1 of ^2 posts...',
		'recalc_points' => 'Recalculate ideator points',
		'recalc_points_complete' => 'All ideator points were successfully recalculated.',
		'recalc_points_note' => ' - for ideator ranking and points displays',
		'recalc_points_recalced' => 'Recalculated for ^1 of ^2 ideators...',
		'recalc_points_usercount' => 'Estimating total number of ideators...',
		'recalc_posts_count' => 'Getting total number of ideas, feedback and comments...',
		...
		'recount_posts_as_recounted' => 'Recounted feedback and hotness for ^1 of ^2 posts...',
		'recount_posts_complete' => 'All posts were successfully recounted.',
		'recount_posts_note' => ' - the number of feedba, votes, flags and hotness for each post',
		...
		'refill_events_note' => ' - for each ideator\'s list of updates',
		'refill_events_refilled' => 'Refilled for ^1 of ^2 ideas...',
		'registration_fields' => 'add registration fields',
		'reindex_content' => 'Reindex content',
		'reindex_content_note' => ' - for searching and related idea suggestions',
		...
		'show_on_register_form' => 'Show field on ideator registration form',
		...
		'tags_not_shown' => 'Some ideas have tags which will not be displayed.',
		...
		'total_as' => 'Total feedback:',
		'total_cs' => 'Total comments:',
		'total_qs' => 'Total ideas:',
		...
		'users_active' => 'Active ideators:',
		'users_must_have' => 'Ideators must have',
		'users_posted' => 'Ideators who posted:',
		'users_registered' => 'Registered ideators:',
		'users_title' => 'Ideators',
		'users_voted' => 'Ideators who voted:',
		'version_get_x' => 'get ^',
